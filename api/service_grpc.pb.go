...
type VotingServiceClient interface {
	...
	ListVoteables(ctx context.Context, in *ListVoteablesRequest, opts ...grpc.CallOption) (*ListVoteablesResponse, error)
...
func (c *votingServiceClient) ListVoteables(ctx context.Context, in *ListVoteablesRequest, opts ...grpc.CallOption) (*ListVoteablesResponse, error) {
...
type VotingServiceServer interface {
	...
	ListVoteables(context.Context, *ListVoteablesRequest) (*ListVoteablesResponse, error)
...
func (UnimplementedVotingServiceServer) ListVoteables(context.Context, *ListVoteablesRequest) (*ListVoteablesResponse, error) {
...
func _VotingService_ListVoteables_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VotingServiceServer).ListVoteables(ctx, req.(*ListVoteablesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
